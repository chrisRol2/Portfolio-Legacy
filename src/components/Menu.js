...
function Menu(props) {
  ...
  return (
    <div id="menu" style={props.style}>
      ...
      <div id="menu__config">
        <div id="menu__config-top" className="menu__config-flex">
          <button
        ...
        <div id="menu__config-bottom" className="menu__config-flex">
          <a
          ...
          {/* {false && <button className="menu__config-btn">🎆</button>} */}
        </div>
      </div>
    </div>
  );
...
export function MenuDesktop(props) {
  ...
  const handleLanguage = () => setLang(lang === "en" ? "es" : "en");
  return (
    <div id="menu-desktop" style={props.style}>
      <div id="menu__config">
        <div id="menu__config-top" className="menu__config-flex">
          <button
            onClick={handleLanguage}
